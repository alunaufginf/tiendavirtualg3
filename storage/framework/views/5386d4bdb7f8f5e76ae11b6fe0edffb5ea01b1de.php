    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><?php echo e($value->nombre_completo); ?></td>
                <td class="text-center"><?php echo e($value->tipo_documento->nombre_corto . ' - '. $value->documento); ?></td>
                <td class="text-center"><?php echo e($value->direccion); ?></td>
                <td class="text-center"><?php echo e($value->email); ?></td>
                <td class="text-center"><?php echo e($value->celular); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\tiendavirtualg3\resources\views/admin/cliente/tabla.blade.php ENDPATH**/ ?>