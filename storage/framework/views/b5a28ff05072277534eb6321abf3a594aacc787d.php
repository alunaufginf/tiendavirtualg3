...
<script>
    ...
    function buscar(pagina = 1){
        ...
        axios.get('<?php echo e(route("marca.buscar")); ?>', {
            "params": {
                "nombre" : nombre,
                "page": pagina
            }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tiendavirtualg3\resources\views/admin/marca/index.blade.php ENDPATH**/ ?>