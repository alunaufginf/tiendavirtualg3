    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="<?php echo e(route('inicio')); ?>" class="h1"><b>Tienda</b>Virtual</a>
            </div>
            <div class="card-body">
                <p class="login-box-msg">Ingresa tus datos</p>
                <form autocomplete="off" action="<?php echo e(route('login')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\tiendavirtualg3\resources\views/auth/login.blade.php ENDPATH**/ ?>