...
<?php $__env->startPush('javascript_extra'); ?>
    <script>
        ...
        function formularioCrear(){
            ...
            axios.get('<?php echo e(route("usuario.create")); ?>')
        ...
        function crear(){
            ...
            axios.post('<?php echo e(route("usuario.store")); ?>', datos)
                .then(function(respuesta){
        ...
        function buscar(pagina = 1){
            ...
            axios.get('<?php echo e(route("usuario.buscar")); ?>', {
                "params": {
                    "nombre" : nombre,
                    "page": pagina
                }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tiendavirtualg3\resources\views/admin/usuario/index.blade.php ENDPATH**/ ?>