                                    ...
                                    <form autocomplete="off" id="formulario_buscar" class="form-inline">
                                        <div class="form-group">
                                            ...
                                            <select onchange="buscar();" name="categoria_id" id="categoria_id"
                                                ...
                                                <?php $__currentLoopData = $categorias_padre; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    function buscar(pagina = 1){
        ...
        axios.get('<?php echo e(route("subcategoria.buscar")); ?>', {
            "params": {
                "nombre" : nombre,
                "page": pagina,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tiendavirtualg3\resources\views/admin/subcategoria/index.blade.php ENDPATH**/ ?>